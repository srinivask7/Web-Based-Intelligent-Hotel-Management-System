...
public class DFS_Music
{
 ...
 {
     // Mark the current node as visited and plays the music 
     visited[v] = true;
     ...
     new javafx.embed.swing.JFXPanel();
		String bip = "C:/Users/Srinivas/Desktop/docs/music/Iravaaga Nee.mp3";
		Media hit = new Media(new File(bip).toURI().toString());
		MediaPlayer mediaPlayer = new MediaPlayer(hit);
		mediaPlayer.play();}
     else if(v==11)
 ...
 {
     DFS_Music g = new DFS_Music(13);
     Scanner scan = new Scanner(System.in);
		System.out.println("Enter the source Press 1 for Bollywood Songs // Press 2 for western songs //Pres 3 for"
				+ "Clasical songs ");
		g.addEdge(0, 1);
		g.addEdge(0, 2);
		g.addEdge(0, 3);
		...
		g.addEdge(7, 12);
     g.DFS(scan.nextInt());
     System.out.println("Following Music Track will be played");     
 }
}